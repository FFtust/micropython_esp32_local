...
const soc_memory_type_desc_t soc_memory_types[] = {
    ...
    { "D/IRAM", { MALLOC_CAP_MP_HEAP, MALLOC_CAP_DMA|MALLOC_CAP_8BIT, MALLOC_CAP_32BIT|MALLOC_CAP_EXEC }, true, true},
    //Type 2: IRAM
...
const soc_reserved_region_t soc_reserved_regions[] = {
    ...
    */
    ...
    // Change by makeblock
    // Can NOT commant, when a BLE HOST Dongle connect to this device more than once.
